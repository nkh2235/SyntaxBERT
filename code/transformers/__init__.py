...
from .data import (is_sklearn_available,
                   InputExample, InputFeatures, DataProcessor, MaskProcessor,
                   glue_output_modes, glue_convert_examples_to_mask_idx, glue_convert_examples_to_features, 
...
if is_torch_available():
    ...
    from .modeling_syntaxbert import (BertPreTrainedModel as SynBertTrainedModel, BertModel as SynBertModel, BertForPreTraining as SynBertForPreTraining,
                                     BertForMaskedLM as SynBertForMaskedLM, BertForNextSentencePrediction as SynBertForNextSentencePrediction,
                                     BertForSequenceClassification as SynBertForSequenceClassification, BertForMultipleChoice as SynBertForMultipleChoice,
                                     BertForTokenClassification as SynBertForTokenClassification, BertForQuestionAnswering as SynBertForQuestionAnswering)
    from .modeling_pmbert import (BertPreTrainedModel as PMBertTrainedModel, BertModel as PMBertModel, BertForPreTraining as PMBertForPreTraining,
                                     BertForMaskedLM as PMBertForMaskedLM, BertForNextSentencePrediction as PMBertForNextSentencePrediction,
                                     BertForSequenceClassification as PMBertForSequenceClassification, BertForMultipleChoice as PMBertForMultipleChoice,
                                     BertForTokenClassification as PMBertForTokenClassification, BertForQuestionAnswering as PMBertForQuestionAnswering)
